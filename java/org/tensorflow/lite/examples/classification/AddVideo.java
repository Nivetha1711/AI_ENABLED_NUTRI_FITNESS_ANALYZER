...
public class AddVideo extends Activity {
	...
	EditText edtSubject, edtLink;
Button btnSubmit,btnSubmit1;
Connection conn;
Spinner spinner1;

private String subject,videolink,username;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtSubject = (EditText) findViewById(R.id.video_subject);

		edtLink = (EditText) findViewById(R.id.video_link);
		...
		btnSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				videolink = edtLink.getText().toString();
...
//		EditText name, userName, password, cpassword, email, phoneNumber;
		...
		if(edtLink.getText().toString().length()<1){edtLink.setError("Field Required");ret=false;}
	...
	public class QuerySQL extends AsyncTask<String, Void, Boolean> {
	    ...
	    protected void onPreExecute() {
	        ...
	        pDialog = new ProgressDialog(AddVideo.this);
	    ...
	    protected Boolean doInBackground(String... args) {
			...
			try {
				...
				int success=statement.executeUpdate("insert into videolist values('"+subject+"','"+videolink+"')");
...
//				Toast.makeText(getBaseContext(),"Successfully Registered...", Toast.LENGTH_LONG).show();
	    ...
	    protected void onPostExecute(Boolean result1) {
	    	...
	    	if(result1)
	    	{
	    		...
	    		Toast.makeText(getBaseContext(),"Successfully Added Video." ,Toast.LENGTH_LONG).show();
